...
#define MESSAGE \
    Dialog1::tr("<p>Message boxes have a caption, a text, " \
               "and any number of buttons, each with standard or custom texts." \
               "<p>Click a button to close the message box. Pressing the Esc button " \
               "will activate the detected escape button (if any).")
#define MESSAGE_DETAILS \
    Dialog1::tr("If a message box has detailed text, the user can reveal it " \
    ...
    : QWidget(parent)
{
    ...
    connect(integerButton, &QAbstractButton::clicked, this, &Dialog1::setInteger);
    connect(doubleButton, &QAbstractButton::clicked, this, &Dialog1::setDouble);
    connect(itemButton, &QAbstractButton::clicked, this, &Dialog1::setItem);
    connect(textButton, &QAbstractButton::clicked, this, &Dialog1::setText);
    connect(multiLineTextButton, &QAbstractButton::clicked, this, &Dialog1::setMultiLineText);
    connect(colorButton, &QAbstractButton::clicked, this, &Dialog1::setColor);
    connect(fontButton, &QAbstractButton::clicked, this, &Dialog1::setFont);
    connect(directoryButton, &QAbstractButton::clicked,
            this, &Dialog1::setExistingDirectory);
    connect(openFileNameButton, &QAbstractButton::clicked,
            this, &Dialog1::setOpenFileName);
    connect(openFileNamesButton, &QAbstractButton::clicked,
            this, &Dialog1::setOpenFileNames);
    connect(saveFileNameButton, &QAbstractButton::clicked,
            this, &Dialog1::setSaveFileName);
    connect(criticalButton, &QAbstractButton::clicked, this, &Dialog1::criticalMessage);
    connect(informationButton, &QAbstractButton::clicked,
            this, &Dialog1::informationMessage);
    connect(questionButton, &QAbstractButton::clicked, this, &Dialog1::questionMessage);
    connect(warningButton, &QAbstractButton::clicked, this, &Dialog1::warningMessage);
    connect(errorButton, &QAbstractButton::clicked, this, &Dialog1::errorMessage);
...
void Dialog1::setExistingDirectory()
{
...
void Dialog1::informationMessage()
{
    QMessageBox::StandardButton reply;
